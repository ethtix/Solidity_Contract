...
contract NFTTicket is ERC721Pausable {
    ...
    // Dummy id parameter input for consistent interface
    function safeMint(address _to, uint256 _tokenId) external onlyMinter {
        _safeMint(_to, _tokenId);
    }
    
    // Batch mint tokens. Assign directly to _to[].
    function safeBatchMint(address[] calldata _to, uint256[] calldata _tokenId) external onlyMinter {
        require(_to.length == _tokenId.length, "Input length dismatched");
